...
# ======= CONFIGURACIONES =======
repositorio = '/home/angeljsh/py/'  # Cambia a tu ruta local si es diferente
archivo = 'contribuciones.txt'
fecha_inicio = '2025-03-24'  # Nueva fecha de inicio
fecha_fin = datetime.today().strftime('%Y-%m-%d')  # Fecha actual
remote_name = 'origin'       # Nombre del remoto (origin por defecto)
branch = 'main'  # Nombre de la rama correcta en GitHub
            # Nombre de la rama (main por defecto)
# ===============================
